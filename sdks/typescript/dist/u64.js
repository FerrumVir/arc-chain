...
exports.U64_MAX = (1n << 64n) - 1n;
/** Convert a public u64 input to its exact bigint representation. */
function u64ToBigInt(value, fieldName) {
    ...
    if (value < 0n || value > exports.U64_MAX) {
        throw new RangeError(`${fieldName} must be in the u64 range (0..${exports.U64_MAX})`);
    }
    return value;
}
/** Fail closed before an inexact or out-of-range u64 reaches the network. */
function assertU64(value, fieldName) {
