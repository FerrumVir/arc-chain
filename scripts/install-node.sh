...
[p2p]
port = 9945
# peers = ["seed1.arc-chain.io:9945", "seed2.arc-chain.io:9945"]
...
echo ""
echo "  ${BOLD}RPC endpoint:${RESET}       http://localhost:9944"
echo "  ${BOLD}Health check:${RESET}       curl http://localhost:9944/health"
echo ""
