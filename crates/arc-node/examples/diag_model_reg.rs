...
use arc_types::transaction::{MIN_MODEL_REGISTRATION_FEE, ModelRegistrationBody, TxBody};
...
async fn main() {
    ...
    for i in 0..70 {
        ...
        println!(
            "[t+{}s] h={} mempool={} tx_endpoint={} from.nonce={}",
            (if i < 10 { i + 1 } else { 10 + (i - 9) * 5 }),
            height,
            mempool,
            tx_status,
            n
