...
We implement the VRF inference committee protocol in ARC Chain, a sender-sharded DAG blockchain written in Rust. The implementation spans 14 crates totaling 80,683 lines of code with 1,185 passing tests.
