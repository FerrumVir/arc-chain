...
|---|---|
| 🍎 **Mac (Apple Silicon - M1/M2/M3/M4)** | **[Download for Apple Silicon Mac](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node_0.5.6_aarch64.dmg)** |
| 🍎 **Mac (Intel)** | **[Download for Intel Mac](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node_0.5.6_x64.dmg)** |
| 🪟 **Windows 10 / 11** | **[Download for Windows](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node_0.5.6_x64-setup.exe)** |
| 🐧 **Linux (Ubuntu / Debian)** | **[Download .deb](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node_0.5.6_amd64.deb)** |
| 🐧 **Linux (Fedora / RHEL)** | **[Download .rpm](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node-0.5.6-1.x86_64.rpm)** |
| 🐧 **Linux (any distro)** | **[Download .AppImage](https://github.com/FerrumVir/arc-chain/releases/download/v0.5.6/ARC.Node_0.5.6_amd64.AppImage)** |
...
- **Linux**: `sudo apt install ./ARC.Node_0.5.6_amd64.deb` (or `rpm -i`, or `chmod +x` the AppImage)
